...
if (( $(tmux_variable_value '@TMUX_CZ_HIDE_LEFT_DECORATION') )); then
  host_name="#{?client_prefix,#[fg=$TMUX_CZ_DARK_GRAY]#[bg=$TMUX_CZ_DARK_ORANGE]#[bold],#[fg=$TMUX_CZ_DARK_ORANGE,bg=$TMUX_CZ_DARK_GRAY]} #H [#S] #{?client_prefix,$TMUX_CZ_DARK_ORANGE_LIGHT_BLACK_LEFT_SEPARATOR,$TMUX_CZ_DARK_GRAY_LIGHT_BLACK_LEFT_SEPARATOR}"
else
...
if (( $(tmux_variable_value '@TMUX_CZ_HIDE_LEFT_DECORATION') )); then
  readonly STATUS_LEFT="$host_name"
else
...
if (( $(tmux_variable_value '@TMUX_CZ_HIDE_RIGHT_DECORATION') )); then
  readonly STATUS_RIGHT="${TMUX_CZ_DARK_GRAY_LIGHT_BLACK_RIGHT_SEPARATOR}${BATTERY_STATUS}${CLOCK}${TMUX_CZ_LIGHT_GRAY_DARK_GRAY_RIGHT_SUBSEPARATOR}${CALENDAR}"
else
